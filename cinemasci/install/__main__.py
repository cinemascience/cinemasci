...
if __name__ == "__main__":
    ...
    installer = install()
    abs_basepath = os.path.abspath(os.path.expanduser(args.database))
    installer.install_viewer( os.path.dirname(abs_basepath), args.viewer, [os.path.basename(args.database)], args.type )
