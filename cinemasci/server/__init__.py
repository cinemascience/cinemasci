...
def set_install_path():
    ...
    CinemaInstallPath = "/" + CinemaInstallPath + "/cview"
    ...
    def do_GET(self):
        ...
        if "viewer" in query_components: 
            ...
            if viewer == "explorer": 
                ...
                self.log("EXPLORER")
                self.path = get_relative_install_path("../cview/cinema_explorer.html")
                return http.server.SimpleHTTPRequestHandler.do_GET(self)

            elif viewer == "view": 
                # handle a request for the Cinema:View viewer
                self.log("VIEW")
                self.path = get_relative_install_path("../cview/cinema_view.html")
                return http.server.SimpleHTTPRequestHandler.do_GET(self)
